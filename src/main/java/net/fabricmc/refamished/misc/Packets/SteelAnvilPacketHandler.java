...
public class SteelAnvilPacketHandler implements CustomPacketHandler {
    ...
    public void handleCustomPacket(Packet250CustomPayload packet, EntityPlayer player) {
        ...
        try {
            ...
            if (packetId == 0) {
                ...
                if (player.openContainer instanceof steelAnvilContainer) {
                    steelAnvilContainer container = (steelAnvilContainer) player.openContainer;
                    steelAnvilTile anvil = container.tile;
