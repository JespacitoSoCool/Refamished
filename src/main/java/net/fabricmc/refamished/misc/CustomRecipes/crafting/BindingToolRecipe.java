...
public class BindingToolRecipe extends ShapelessRecipes {
    private final List<ItemStack> ingredients;
    public BindingToolRecipe(ItemStack output, List<ItemStack> recipeItems) {
        super(output, WoolCutting.toListToTag(recipeItems));
    ...
    public ItemStack getCraftingResult(InventoryCrafting craftingGrid) {
        ...
        output.getTagCompound().setInteger("binding", bindingColor);
