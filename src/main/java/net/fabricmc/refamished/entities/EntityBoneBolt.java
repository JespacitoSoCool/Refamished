...
public class EntityBoneBolt extends EntityArrow implements EntityWithCustomPacket {

    public EntityBoneBolt(World par1World) {
        super(par1World);
    }

    public EntityBoneBolt(World par1World, double par2, double par4, double par6) {
        super(par1World);
    ...
    public EntityBoneBolt(World par1World, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase, float par4, float par5) {
        super(par1World);
        this.renderDistanceWeight = 10.0;
    ...
    public EntityBoneBolt(World par1World, EntityLivingBase par2EntityLivingBase, float par3) {
        super(par1World);
        this.renderDistanceWeight = 10.0;
        this.shootingEntity = par2EntityLivingBase;
        if (par2EntityLivingBase instanceof EntityPlayer) {
    ...
    public Item getCorrespondingItem() {
        return RefamishedItems.bolt_bone;
    }


    @Override
    public Packet getSpawnPacketForThisEntity() {
        return new Packet23VehicleSpawn(this, EntityBoneBolt.getVehicleSpawnPacketType(), this.shootingEntity == null ? this.entityId : this.shootingEntity.entityId);
    }
