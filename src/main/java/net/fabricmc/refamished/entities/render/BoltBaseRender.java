...
public class BoltBaseRender extends Render {
    private static ResourceLocation ARROW = new ResourceLocation("refamished:textures/models/arrow_flint.png");

    public BoltBaseRender(String texturename)
    {
        ARROW = new ResourceLocation("refamished:textures/models/"+texturename+".png");
    }
