...
public class ArrowFrostRender extends Render {
    private static final ResourceLocation ARROW = new ResourceLocation("refamished:textures/models/arrow_frost.png");

    @Override
    public void doRender(Entity entity, double d, double d1, double d2, float f, float f1) {
        this.renderArrow((EntityFrostArrow)entity, d, d1, d2, f, f1);
    }
    ...
    public void renderArrow(EntityFrostArrow entityarrow, double d, double d1, double d2, float f, float f1) {
