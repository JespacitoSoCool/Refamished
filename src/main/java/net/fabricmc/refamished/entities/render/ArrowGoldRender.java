...
public class ArrowGoldRender extends Render {
    private static final ResourceLocation ARROW = new ResourceLocation("refamished:textures/models/arrow_gold.png");

    @Override
    public void doRender(Entity entity, double d, double d1, double d2, float f, float f1) {
        this.renderArrow((EntityGoldArrow)entity, d, d1, d2, f, f1);
    }
    ...
    public void renderArrow(EntityGoldArrow entityarrow, double d, double d1, double d2, float f, float f1) {
