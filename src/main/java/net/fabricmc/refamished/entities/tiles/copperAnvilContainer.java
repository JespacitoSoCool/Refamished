...
public class copperAnvilContainer extends stoneAnvilContainer {
    public copperAnvilTile tile;

    public copperAnvilContainer(InventoryPlayer playerInventory, copperAnvilTile tile) {
