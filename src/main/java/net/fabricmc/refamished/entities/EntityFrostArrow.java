...
public class EntityFrostArrow extends EntityArrowHitable implements EntityWithCustomPacket {
    ...
    public void onEntityHit(Entity ent)
    {
        ...
        {
            ((EntityLivingBase)ent).addPotionEffect( new PotionEffect( Potion.moveSlowdown.id, 15 * 20, 0 ) );
        }
    }
    ...
    public Item getCorrespondingItem() {
        return RefamishedItems.arrow_frozen;
    }


    @Override
    public Packet getSpawnPacketForThisEntity() {
        return new Packet23VehicleSpawn(this, EntityFrostArrow.getVehicleSpawnPacketType(), this.shootingEntity == null ? this.entityId : this.shootingEntity.entityId);
    }
