...
public class sugarCaneCuttingMachete extends ribCarvingMachete implements ProgressiveCraftingInterface {
    public sugarCaneCuttingMachete(int iItemID) {
        super(iItemID);
    }
    ...
    public Icon getIconFromDamageForRenderPass(int damage, int renderPass) {
        if (renderPass == 0) {
            if (damage == 0) {
                ...
                if (m_recipientIcon[5 - progressIndex] == null) {
