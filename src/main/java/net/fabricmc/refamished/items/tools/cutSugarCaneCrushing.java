...
public class cutSugarCaneCrushing extends leatherWorkFlint {
    public cutSugarCaneCrushing(int iItemID) {
        super(iItemID);
    }

    private Icon[] m_recipientIcon = new Icon[5];
    @Override
    ...
    public ItemStack onEaten( ItemStack stack, World world, EntityPlayer player )
    {
        ...
        world.playSoundAtEntity( player, "step.cloth", 1.0F, world.rand.nextFloat() * 0.1F + 0.9F );
            UtilItem.GivePlayerStackOrEject( player, new ItemStack(RefamishedItems.flintBlade));
