...
public class WoodenClub extends ClubItem {

    protected int var;
    public WoodenClub(int iItemID, int iDurability, int iWeaponDamage, String sName, int Var) {
    ...
    public void registerIcons(IconRegister register) {
        ...
        handleTextures[1] = register.registerIcon("refamished:pieces/colored_handle"); // Colored handle
