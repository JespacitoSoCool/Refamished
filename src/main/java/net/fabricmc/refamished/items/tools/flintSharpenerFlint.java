...
public class flintSharpenerFlint extends ProgressiveCraftingItem {

    public flintSharpenerFlint(int par1) {
        super(par1);
        setUnlocalizedName( "flintSharpenerFlint" );
        this.setMaxStackSize(1);
        setTextureName("refamished:progressive/flintSharpenerFlint");
    }
    ...
    public ItemStack onEaten( ItemStack stack, World world, EntityPlayer player )
    {
        ...
        return new ItemStack( RefamishedItems.flintBlade, 1);
    }
