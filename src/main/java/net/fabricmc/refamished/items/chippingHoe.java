...
public class chippingHoe extends craftingPulling
{
    public chippingHoe(int iItemID) {
        super(iItemID);

        setUnlocalizedName( "chippingHoe" );
    ...
    public void craft(ItemStack itemStack, World world, EntityPlayer player) {
        ...
        player.inventory.mainInventory[player.inventory.currentItem] = new ItemStack( RefamishedItems.chippedHoeHead, 1);
    }
