...
public class bowStringingFlint extends bowStringing {
    public bowStringingFlint(int iItemID) {
        super(iItemID);
        setUnlocalizedName( "bow_stringing" );
        setTextureName("refamished:stringing_flint");
    }
    ...
    public void onPlayerStoppedUsing( ItemStack itemStack, World world, EntityPlayer player, int iTicksInUseRemaining )
    {
        ...
        if (var6 > 23 && var6 < 35)
        {
            ...
            player.inventory.mainInventory[player.inventory.currentItem] = new ItemStack( RefamishedItems.incendiary_bow, 1, 0);
        ...
        else if (var6 > 29)
        {
            ...
            GivePlayerStackOrEject( player, new ItemStack(RefamishedItems.flint_bow_igniter, 1));
        }
    ...
    public void registerIcons( IconRegister register )
    {
        ...
        for (int i = 0; i < m_pullIcon.length; i++) {
            m_pullIcon[i] = register.registerIcon("refamished:progressive/stringing_flint_" + i);
        }
