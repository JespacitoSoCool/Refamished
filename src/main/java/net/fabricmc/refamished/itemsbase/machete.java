...
public class machete extends Item implements PlaceableAsItem
{
    ...
    public Multimap getItemAttributeModifiers() {
        ...
        var1.put(ResharedMonsterAttributes.toolRange.getAttributeUnlocalizedName(), new AttributeModifier(RefamishedAddon.toolRangeUUID, "Tool Range", this.m_iReach, AttributeOperation.ADDITIVE.value));
        var1.put(ResharedMonsterAttributes.attackRange.getAttributeUnlocalizedName(), new AttributeModifier(RefamishedAddon.toolRangeUUID, "Attack Range", this.m_iReach, AttributeOperation.ADDITIVE.value));
        return var1;
    }
